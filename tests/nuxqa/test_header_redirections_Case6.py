...
def test_header_redirections(driver, base_url, db, header_link, browser, screenshots_mode):
    """
    ...
    - Por defecto: 3 header links × 2 envs × 3 navegadores = 18 tests
    - Ejemplo: --browser=chrome --header-link=hoteles --env=qa4 → 1 test
